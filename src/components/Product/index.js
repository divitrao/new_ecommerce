...
import { style, styles } from "styled-system"

const Header=()=> {
  return (
    <Stack space={2} style={productStyles.stack}>
        
      <HStack space={3} alignItems="center"  style={productStyles.hstack}>

      <Center size={16} bg="#E7E7E7" shadow={3}></Center>
      <Center size={16} bg="#E7E7E7" shadow={3}></Center>
      <Center size={16} bg="#E7E7E7" shadow={3}></Center>
...
const BodyComponent=()=>{
    ...
    return (
        ...
        <View >   
        <Center mt="1"  style={productStyles.bodyCenter} >
  ...
  const OtherProducts=({category})=>{
    ...
    return (
        ...
        <View style={productStyles.productsView}>      
                ...
                <FlatList 
                        ...
                        renderItem={({item})=>{
                            return(
                                ...
                                <NativeBaseProvider>
                                <HStack space={6} style={productStyles.productsHstack}>
                        
                        <View style={productStyles.productsSubView}>
                            <View >
                                <Image source={item.image} resizeMode="contain" alt="Image description" style={productStyles.image}/>
                           </View>
                            
                            <View style={productStyles.dropdownView}>
                    ...
                    <VStack style={productStyles.mainContentVstack}>
                        <View style={productStyles.mainContentView}>
                            <View style={productStyles.mainContentSubView}>
                                ...
                                <Image resizeMode='contain' alt="currency" source={require('../../assets/images/currency_b.png')} />{item.discount_amount}
                                    <Text bold style={productStyles.imageText}>
                                  ...
                                  <Badge bgColor="#2898FF" justifyContent="center" variant='solid' borderRadius="6" height="7" width="50" marginLeft="4" >
                                     <Text fontWeight="bold" color="white" >{item.discount_perc}</Text></Badge>
                            </View>
                            
                        </View>

                        <View style={{height:60}}>
                        <Text _dark={{color: "warmGray.50",}} color="coolGray.800" bold style={productStyles.content}>
                            {item.content}                            
                        </Text>
                        </View>
                        ...
                        <View style={productStyles.buttonView}>
    ...
    <NativeBaseProvider>
        <ScrollView >
            ...
            <View bgColor="white"  flex='1'>
                <View>
                    <Center alignItems="flex-end" style={productStyles.detailsCenter}> 
                    ...
                    <Heading size="sm" style={productStyles.heading,[color='#7C7C7C']}>About this product</Heading>
                        <InformationComponent  />
                        <Heading size="md" style={productStyles.heading}>Frequently bought togeather</Heading>
                        <OtherProducts category={"frequently"}/>
                        <Divider style={productStyles.divider}/>
                        <Heading size="md" style={productStyles.heading}>Best offer for you</Heading>
                        <OtherProducts  />
                        <Divider style={productStyles.divider}/>
